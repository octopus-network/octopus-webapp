...
export const validateValidatorStake = async (anchor: AnchorContract, depositAmount: Decimal, type: 'IncreaseStake' | 'IncreaseDelegation' | 'DecreaseStake' | 'DecreaseDelegation', validator?: Validator, appchain?: AppchainInfoWithAnchorStatus) => {
  try {
    ...
    if (['IncreaseDelegation', 'IncreaseStake'].includes(type) && validator && appchain) {
