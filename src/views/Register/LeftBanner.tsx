...
export const LeftBanner: React.FC = () => {
  return (
    <Box borderRadius="lg" bg="#1486ff" h="100%" p={6} position="relative" color="white" overflow="hidden" w="100%">
      <Heading fontSize="3xl" mt={3}>Octopus Network</Heading>
      <Box mt={3}>
        <Text fontSize="lg" opacity=".7">A more flexible multi-chain network</Text>
      </Box>
      ...
      <Box position="absolute" w="60%" bottom="-80px" right="-30px" zIndex={1} opacity=".3">
        <Image src={bigBubble} w="100%" />
      </Box>
