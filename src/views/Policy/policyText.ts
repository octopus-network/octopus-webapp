...
This privacy notice for CDOT Technologies Limited (doing business as Octopus Network) ("**Octopus Network**," "**we**," "**us**," or "**our**"), describes how and why we might collect, store, use, and/or share ("**process**") your information when you use our services ("**Services**"), such as when you:

- Visit our website at [https://mainnet.oct.network](https://mainnet.oct.network), or any website of ours that links to this privacy notice

- Engage with us in other related ways, including any sales, marketing, or events

**Questions or concerns?** Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at hi@oct.network.
...
**What personal information do we process?** When you visit, use, or navigate our Services, we may process personal information depending on how you interact with Octopus Network and the Services, the choices you make, and the products and features you use. Click [here](#personalinfo) to learn more.
...
Want to learn more about what Octopus Network does with any information we collect? Click [here](#toc) to review the notice in full.
...
[8. HOW DO WE USE GOOGLE USER DATA?](#infominors)
...
**8. HOW DO WE USE GOOGLE USER DATA?**

**_In Short:_** _We do not store any Google user data._

We only deploy one configured VM instance for the user, after user authorizes it though OAuth Consent Screen. Users can delete the VM instance from the Google Cloud Console or our website (Authorization is required) at any time. Users can also choose to remove the access after deploying the VM instance from the Google Account page: [https://myaccount.google.com/permissions](https://myaccount.google.com/permissions).
...
If you have questions or comments about your privacy rights, you may email us at hi@oct.network.
...
If you have questions or comments about this notice, you may email us at hi@oct.network or by post to:

CDOT Technologies Limited

306 Victoria House

Victoria, Mahé 881738

Seychelles

**14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?**

Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please contact us at hi@oct.network.`;
